...
var tokenizePHP = (function() {
  ...
  // A map of PHP's keywords. The a/b/c keyword distinction is
  // very rough, but it gives the parser enough information to parse
  // correct code correctly (we don't care that much how we parse
  // incorrect code). The style information included in these objects
  // is used by the highlighter to pick the correct CSS style for a token.
  //
  ...
  var keywords = function(){
    ...
    // keywords that optionally take an expression, and form a statement 
    ["if", "elseif", "switch", "while", "declare"].forEach(function(element, index, array) {
    ...
    // keywords that take a parenthised expression, and then a statement 
    ...
    // TODO: Extension functions: http://www.php.net/manual/en/aliases.php  
    return result;
  ...
  function phpToken(inside, source, setInside) {
    ...
    function readStringDoubleQuoted() {
      // TODO: highlight interpolated variables, including method calls
      var endBackSlash = nextUntilUnescaped(source, "\"");
      setInside(endBackSlash ? "\"": null);
