;bespin.tiki.register("::sqlsyntax", {
    name: "sqlsyntax",
    dependencies: { "syntax_manager": "0.0.0" }
});
bespin.tiki.module("sqlsyntax:index",function(require,exports,module) {
/*
...
;bespin.tiki.register("::phpsyntax", {
    name: "phpsyntax",
    dependencies: { "standard_syntax": "0.0.0" }
});
bespin.tiki.module("phpsyntax:index",function(require,exports,module) {
/*
